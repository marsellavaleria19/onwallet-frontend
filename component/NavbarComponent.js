            ...
            <Offcanvas show={show} onHide={handleClose} className={'bg-secondary'}>
               ...
               <Offcanvas.Body>
                  <div className='text-center mt-5'>
                     ...
                     <div className='mt-3'>
                        <div className={`${canvas.textName} fw-bold text-primary ms-3`}>{auth!==null && auth.user!==null && auth.user.fullName}</div>
                  ...
                  <div className={menu.menuCanvas}>
                     <div> 
                        <ul className={`${menu.menuItem} me-5 ms-5`}>
                           {
                              listMenu.map(item => {
                           ...
                           <div className={`${menu.layoutButtonLogout} mt-5`}>
